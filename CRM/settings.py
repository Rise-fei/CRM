...
SECRET_KEY = 'sy-fao9%0d^q8#tfyzf@q#x33-pz(aohb$q5k&l=l7d3%7*m)r'
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.mysql',  # 数据的类型 MySQL oracle
...
AUTH_USER_MODEL = 'userpermission.UserInfo'
